...
to turtleMoveOne
  ...
  setxy random-xcor random-ycor                                          ; self-explanatory - set x, y coords of turtles to a random x coordinate and random y coordinate
end

to turtleMoveTwo
  pd                                                                     ; pd = pendown
  setxy random-xcor random-ycor                                          ; as seen above
end

to turtleMoveThree
  pu                                                                     ; to avoid issues with pen still being down when calling this function
  setxy random-float max-pxcor random-float max-pycor             ; this calculates the height of the world, divides it by two, and then puts the turtle's coordinates at a random point between the max and 0 using the random function
end
